...
# Sensitivity analysis using the best diagnostic accuracy epilepsy definition in: Evolution in the prescription and cost of non-intravenous rescue benzodiazepines for the treatment of seizure emergencies
...
codes_epilepsy_ICD9 <- c("345", "3450", "34500", "34501", "3451", "34510", "34511", "3454", "34540", "34541", "3455", "34550", "34551", "3457", "34570", "34571", "3458", "34580", "34581", "3459", "34590", "34591")

codes_epilepsy_ICD10 <- c("G40", "G400", "G4000", "G40001", "G40009", "G4001", "G40011", "G40019", "G401", "G4010", "G40101", "G40109", "G4011", "G40111", "G40119", "G402", "G4020", "G40201", "G40209", "G4021", "G40211", "G40219", "G403", "G4030", "G40301", "G40309", "G4031", "G40311", "G40319", "G40A", "G40A0", "G40A01", "G40A09", "G40A1", "G40A11", "G40A19", "G40B", "G40B0", "G40B01", "G40B09", "G40B1", "G40B11", "G40B19", "G404", "G4040", "G40401", "G40409", "G4041", "G40411", "G40419", "G408", "G4080", "G40801", "G40802", "G40803", "G40804", "G4081", "G40811", "G40812", "G40813", "G40814", "G4083", "G40833", "G40834", "G409", "G4090", "G40901", "G40909", "G4091", "G40911", "G40919")
...
epilepsy_2006_i <- ms_i_2006 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9,
  ...
  filter(
                                        ...
                                        DX2 %in% codes_epilepsy_ICD9 |
                                        DX3 %in% codes_epilepsy_ICD9 | 
                                        DX4 %in% codes_epilepsy_ICD9 |
                                        DX5 %in% codes_epilepsy_ICD9 | 
                                        DX6 %in% codes_epilepsy_ICD9 |
                                        DX7 %in% codes_epilepsy_ICD9 | 
                                        DX8 %in% codes_epilepsy_ICD9 |
                                        DX9 %in% codes_epilepsy_ICD9 | 
                                        DX10 %in% codes_epilepsy_ICD9 |
                                        DX11%in% codes_epilepsy_ICD9 | 
                                        DX12 %in% codes_epilepsy_ICD9 |
                                        DX13 %in% codes_epilepsy_ICD9 | 
                                        DX14 %in% codes_epilepsy_ICD9 |
                                      ...
                                      select(ENROLID, SVCDATE, type)

epilepsy_2006_o <- ms_o_2006 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
...
epilepsy_2006_s <- ms_s_2006 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2007_o <- ms_o_2007 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2007_s <- ms_s_2007 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2008_o <- ms_o_2008 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2008_s <- ms_s_2008 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2009_o <- ms_o_2009 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2009_s <- ms_s_2009 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2010_o <- ms_o_2010 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2010_s <- ms_s_2010 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2011_o <- ms_o_2011 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2011_s <- ms_s_2011 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2012_o <- ms_o_2012 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2012_s <- ms_s_2012 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2013_o <- ms_o_2013 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2013_s <- ms_s_2013 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2014_o <- ms_o_2014 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2014_s <- ms_s_2014 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2015_i <- ms_i_2015 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9,
  ...
  filter(
                                        ...
                                        DX14 %in% codes_epilepsy_ICD9 |
                                        DX15 %in% codes_epilepsy_ICD9 |
                                        DX1 %in% codes_epilepsy_ICD10 | 
                                        DX2 %in% codes_epilepsy_ICD10 |
                                        DX3 %in% codes_epilepsy_ICD10 | 
                                        DX4 %in% codes_epilepsy_ICD10 |
                                        DX5 %in% codes_epilepsy_ICD10 | 
                                        DX6 %in% codes_epilepsy_ICD10 |
                                        DX7 %in% codes_epilepsy_ICD10 | 
                                        DX8 %in% codes_epilepsy_ICD10 |
                                        DX9 %in% codes_epilepsy_ICD10 | 
                                        DX10 %in% codes_epilepsy_ICD10 |
                                        DX11%in% codes_epilepsy_ICD10 | 
                                        DX12 %in% codes_epilepsy_ICD10 |
                                        DX13 %in% codes_epilepsy_ICD10 | 
                                        DX14 %in% codes_epilepsy_ICD10 |
...
epilepsy_2015_o <- ms_o_2015 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9 |  
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10  
...
epilepsy_2015_s <- ms_s_2015 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD9 | 
                                     DX2 %in% codes_epilepsy_ICD9 |  
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                                 
...
epilepsy_2016_o <- ms_o_2016 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2016_s <- ms_s_2016 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2017_o <- ms_o_2017 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2017_s <- ms_s_2017 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2018_o <- ms_o_2018 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2018_s <- ms_s_2018 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2019_o <- ms_o_2019 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2019_s <- ms_s_2019 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2020_o <- ms_o_2020 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2020_s <- ms_s_2020 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2021_o <- ms_o_2021 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2021_s <- ms_s_2021 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
epilepsy_2022_o <- ms_o_2022 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                              
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type=case_when(
...
epilepsy_2022_s <- ms_s_2022 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% filter(
                                     DX1 %in% codes_epilepsy_ICD10 | 
                                     DX2 %in% codes_epilepsy_ICD10                               
                                     ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                     mutate(type = case_when(
...
# Patients with epilepsy (at least 2 different physician claim codes for epilepsy or at least 1 inpatient claim code for epilepsy)
epilepsy <- bind_rows(epilepsy_2006_i, epilepsy_2006_o, epilepsy_2006_s, epilepsy_2007_i, epilepsy_2007_o, epilepsy_2007_s, epilepsy_2008_i, epilepsy_2008_o, epilepsy_2008_s, epilepsy_2009_i, epilepsy_2009_o, epilepsy_2009_s, epilepsy_2010_i, epilepsy_2010_o, epilepsy_2010_s, epilepsy_2011_i, epilepsy_2011_o, epilepsy_2011_s, epilepsy_2012_i, epilepsy_2012_o, epilepsy_2012_s, epilepsy_2013_i, epilepsy_2013_o, epilepsy_2013_s, epilepsy_2014_i, epilepsy_2014_o, epilepsy_2014_s, epilepsy_2015_i, epilepsy_2015_o, epilepsy_2015_s, epilepsy_2016_i, epilepsy_2016_o, epilepsy_2016_s, epilepsy_2017_i, epilepsy_2017_o, epilepsy_2017_s, epilepsy_2018_i, epilepsy_2018_o, epilepsy_2018_s, epilepsy_2019_i, epilepsy_2019_o, epilepsy_2019_s, epilepsy_2020_i, epilepsy_2020_o, epilepsy_2020_s, epilepsy_2021_i, epilepsy_2021_o, epilepsy_2021_s, epilepsy_2022_i, epilepsy_2022_o, epilepsy_2022_s) %>% 
  ...
  mutate(physician_claims_epilepsy = case_when(
    type=="outpatient" ~ 1,
    TRUE ~ 0
  )) %>% 
  group_by(ENROLID) %>% 
  mutate(epilepsy_diagnosis = case_when(
    any(type=="inpatient", na.rm=TRUE) ~ "yes",
    sum(physician_claims_epilepsy) > 1 ~ "yes",
    TRUE ~ "no"
  )) %>% 
  ungroup() %>% 
  filter(epilepsy_diagnosis=="yes") %>% 
...
codes_refractory_epilepsy_ICD9 <- c("34501", "34511", "34541", "34551", "34571", "34581", "34591")

codes_refractory_epilepsy_ICD10 <- c("G4001", "G40011", "G40019", "G4011", "G40.111", "G40119", "G4021", "G40211", "G40219", "G4031", "G40311", "G40319", "G40A1", "G40A11", "G40A19", "G40B1", "G40B11", "G40B19", "G4041", "G40411", "G40419", "G40803", "G40804", "G40813", "G40814", "G40833", "G40834", "G4091", "G40911", "G40919")
...
Patients with epilepsy and antiseizure medications
```{r}
...
patients_with_epilepsy_and_ASM_2022 <- ms_d_2022 %>% 
  ...
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(ASM = case_when(
    NDCNUM %in% codes_NDCNUM_phenobarbital_2022 ~ "phenobarbital",
    NDCNUM %in% codes_NDCNUM_phenytoin_2022 ~ "phenytoin",
    NDCNUM %in% codes_NDCNUM_valproate_2022 ~ "valproate",
    NDCNUM %in% codes_NDCNUM_carbamazepine_2022 ~ "carbamazepine",
    NDCNUM %in% codes_NDCNUM_oxcarbazepine_2022 ~ "oxcarbazepine",                                   NDCNUM %in% codes_NDCNUM_rufinamide_2022 ~ "rufinamide",       
    NDCNUM %in% codes_NDCNUM_levetiracetam_2022 ~ "levetiracetam",
    NDCNUM %in% codes_NDCNUM_lamotrigine_2022 ~ "lamotrigine",
    NDCNUM %in% codes_NDCNUM_brivaracetam_2022 ~ "brivaracetam",                                     NDCNUM %in% codes_NDCNUM_cenobamate_2022 ~ "cenobamate", 
    NDCNUM %in% codes_NDCNUM_clobazam_2022 ~ "clobazam",
    NDCNUM %in% codes_NDCNUM_eslicarbazepine_2022 ~ "eslicarbazepine",
    NDCNUM %in% codes_NDCNUM_ethosuximide_2022 ~ "ethosuximide",
    NDCNUM %in% codes_NDCNUM_lacosamide_2022 ~ "lacosamide",    
    NDCNUM %in% codes_NDCNUM_perampanel_2022 ~ "perampanel",
    NDCNUM %in% codes_NDCNUM_stiripentol_2022 ~ "stiripentol",
    NDCNUM %in% codes_NDCNUM_topiramate_2022 ~ "topiramate",
    NDCNUM %in% codes_NDCNUM_vigabatrin_2022 ~ "vigabatrin",
    NDCNUM %in% codes_NDCNUM_zonisamide_2022 ~ "zonisamide",
    NDCNUM %in% codes_NDCNUM_felbamate_2022 ~ "felbamate",
    NDCNUM %in% codes_NDCNUM_pregabalin_2022 ~ "pregabalin",
    NDCNUM %in% codes_NDCNUM_tiagabine_2022 ~ "tiagabine",                                     
    NDCNUM %in% codes_NDCNUM_cannabidiol_2022 ~ "cannabidiol",
    NDCNUM %in% codes_NDCNUM_gabapentin_2022 ~ "gabapentin",
    NDCNUM %in% codes_NDCNUM_fenfluramine_2022 ~ "fenfluramine",
    NDCNUM %in% codes_NDCNUM_methsuximide_2022 ~ "methsuximide"
  ))
...
patients_with_epilepsy_and_ASM <- bind_rows(patients_with_epilepsy_and_ASM_2006, patients_with_epilepsy_and_ASM_2007, patients_with_epilepsy_and_ASM_2008, patients_with_epilepsy_and_ASM_2009, patients_with_epilepsy_and_ASM_2010, patients_with_epilepsy_and_ASM_2011, patients_with_epilepsy_and_ASM_2012, patients_with_epilepsy_and_ASM_2013, patients_with_epilepsy_and_ASM_2014, patients_with_epilepsy_and_ASM_2015, patients_with_epilepsy_and_ASM_2016, patients_with_epilepsy_and_ASM_2017, patients_with_epilepsy_and_ASM_2018, patients_with_epilepsy_and_ASM_2019, patients_with_epilepsy_and_ASM_2020, patients_with_epilepsy_and_ASM_2021, patients_with_epilepsy_and_ASM_2022) %>% 
  distinct(ENROLID, SVCDATE, ASM, .keep_all=TRUE) %>% 
  arrange(ENROLID, SVCDATE) %>% 
  collect()
...
codes_seizure_ICD9 <- c("3452", "3453", "7790", "7803", "78039")
codes_seizure_ICD10 <- c("G4089", "P90", "R56", "R569")
revenue_codes_EDvisits <- c("0450", "0451", "0452", "0456", "0459", "0981")
place_of_service_codes_EDvisits <- c("20", "23", "41", "42")
CPT_codes_EDvisits <- c("99281", "99282", "99283", "99284", "99285")
service_subcategory_codes_EDvisits <- c("10120", "10220", "10320", "10420", "10520", "12220", "20120", "20220", "21120", "21220", "22120", "22320")
...
IP_ED_2006_i <- ms_i_2006 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  ...
  ((DX1 %in% codes_epilepsy_ICD9) | (DX1 %in% codes_seizure_ICD9)) ~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
...
IP_ED_2015_i <- ms_i_2015 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  ...
  mutate(type="inpatient") %>% 
  mutate(epilepsy_encounter = case_when(
  ((DX1 %in% codes_epilepsy_ICD9) | (DX1 %in% codes_seizure_ICD9) |
  (DX1 %in% codes_epilepsy_ICD10) | (DX1 %in% codes_seizure_ICD10)) ~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  select(ENROLID, SVCDATE, type, epilepsy_encounter)
...
# Dementia
#################################2006#################################
Dementia_2006_i <- ms_i_2006 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
  mutate(dementia_diagnosis = case_when(
  ((DX1 %in% codes_dementia_ICD9) | (DX2 %in% codes_dementia_ICD9) | (DX3 %in% codes_dementia_ICD9) | (DX4 %in% codes_dementia_ICD9) | (DX5 %in% codes_dementia_ICD9) | (DX6 %in% codes_dementia_ICD9) | (DX7 %in% codes_dementia_ICD9) | (DX8 %in% codes_dementia_ICD9) | (DX9 %in% codes_dementia_ICD9) | (DX10 %in% codes_dementia_ICD9) | (DX11 %in% codes_dementia_ICD9) | (DX12 %in% codes_dementia_ICD9) | (DX13 %in% codes_dementia_ICD9) | (DX14 %in% codes_dementia_ICD9) | (DX15 %in% codes_dementia_ICD9))~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  select(ENROLID, SVCDATE, dementia_diagnosis)

Dementia_2006_o <- ms_o_2006 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
  mutate(dementia_diagnosis = case_when(
  ((DX1 %in% codes_dementia_ICD9) | (DX2 %in% codes_dementia_ICD9)) ~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  select(ENROLID, SVCDATE, dementia_diagnosis)

Dementia_2006_s <- ms_s_2006 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2007#################################
Dementia_2007_i <- ms_i_2007 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2007_o <- ms_o_2007 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2007_s <- ms_s_2007 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2008#################################
Dementia_2008_i <- ms_i_2008 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2008_o <- ms_o_2008 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2008_s <- ms_s_2008 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2009#################################
Dementia_2009_i <- ms_i_2009 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2009_o <- ms_o_2009 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2009_s <- ms_s_2009 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2010#################################
Dementia_2010_i <- ms_i_2010 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2010_o <- ms_o_2010 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2010_s <- ms_s_2010 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2011#################################
Dementia_2011_i <- ms_i_2011 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2011_o <- ms_o_2011 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2011_s <- ms_s_2011 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2012#################################
Dementia_2012_i <- ms_i_2012 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2012_o <- ms_o_2012 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2012_s <- ms_s_2012 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2013#################################
Dementia_2013_i <- ms_i_2013 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2013_o <- ms_o_2013 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2013_s <- ms_s_2013 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2014#################################
Dementia_2014_i <- ms_i_2014 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2014_o <- ms_o_2014 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2014_s <- ms_s_2014 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2015#################################
Dementia_2015_i <- ms_i_2015 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
  mutate(dementia_diagnosis = case_when(
  ((DX1 %in% codes_dementia_ICD9) | (DX2 %in% codes_dementia_ICD9) | (DX3 %in% codes_dementia_ICD9) | (DX4 %in% codes_dementia_ICD9) | (DX5 %in% codes_dementia_ICD9) | (DX6 %in% codes_dementia_ICD9) | (DX7 %in% codes_dementia_ICD9) | (DX8 %in% codes_dementia_ICD9) | (DX9 %in% codes_dementia_ICD9) | (DX10 %in% codes_dementia_ICD9) | (DX11 %in% codes_dementia_ICD9) | (DX12 %in% codes_dementia_ICD9) | (DX13 %in% codes_dementia_ICD9) | (DX14 %in% codes_dementia_ICD9) | (DX15 %in% codes_dementia_ICD9) | (DX1 %in% codes_dementia_ICD10) | (DX2 %in% codes_dementia_ICD10) | (DX3 %in% codes_dementia_ICD10) | (DX4 %in% codes_dementia_ICD10) | (DX5 %in% codes_dementia_ICD10) | (DX6 %in% codes_dementia_ICD10) | (DX7 %in% codes_dementia_ICD10) | (DX8 %in% codes_dementia_ICD10) | (DX9 %in% codes_dementia_ICD10) | (DX10 %in% codes_dementia_ICD10) | (DX11 %in% codes_dementia_ICD10) | (DX12 %in% codes_dementia_ICD10) | (DX13 %in% codes_dementia_ICD10) | (DX14 %in% codes_dementia_ICD10) | (DX15 %in% codes_dementia_ICD10)) ~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  select(ENROLID, SVCDATE, dementia_diagnosis)

Dementia_2015_o <- ms_o_2015 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
  mutate(dementia_diagnosis = case_when(
  ((DX1 %in% codes_dementia_ICD9) | (DX2 %in% codes_dementia_ICD9) | (DX1 %in% codes_dementia_ICD10) | (DX2 %in% codes_dementia_ICD10)) ~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  select(ENROLID, SVCDATE, dementia_diagnosis)

Dementia_2015_s <- ms_s_2015 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2016#################################
Dementia_2016_i <- ms_i_2016 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
  mutate(dementia_diagnosis = case_when(
  ((DX1 %in% codes_dementia_ICD10) | (DX2 %in% codes_dementia_ICD10) | (DX3 %in% codes_dementia_ICD10) | (DX4 %in% codes_dementia_ICD10) | (DX5 %in% codes_dementia_ICD10) | (DX6 %in% codes_dementia_ICD10) | (DX7 %in% codes_dementia_ICD10) | (DX8 %in% codes_dementia_ICD10) | (DX9 %in% codes_dementia_ICD10) | (DX10 %in% codes_dementia_ICD10) | (DX11 %in% codes_dementia_ICD10) | (DX12 %in% codes_dementia_ICD10) | (DX13 %in% codes_dementia_ICD10) | (DX14 %in% codes_dementia_ICD10) | (DX15 %in% codes_dementia_ICD10))~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  select(ENROLID, SVCDATE, dementia_diagnosis)

Dementia_2016_o <- ms_o_2016 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
  mutate(dementia_diagnosis = case_when(
  ((DX1 %in% codes_dementia_ICD10) | (DX2 %in% codes_dementia_ICD10)) ~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  select(ENROLID, SVCDATE, dementia_diagnosis)

Dementia_2016_s <- ms_s_2016 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2017#################################
Dementia_2017_i <- ms_i_2017 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2017_o <- ms_o_2017 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2017_s <- ms_s_2017 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2018#################################
Dementia_2018_i <- ms_i_2018 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2018_o <- ms_o_2018 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2018_s <- ms_s_2018 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2019#################################
Dementia_2019_i <- ms_i_2019 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2019_o <- ms_o_2019 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2019_s <- ms_s_2019 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2020#################################
Dementia_2020_i <- ms_i_2020 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2020_o <- ms_o_2020 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2020_s <- ms_s_2020 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2021#################################
Dementia_2021_i <- ms_i_2021 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2021_o <- ms_o_2021 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2021_s <- ms_s_2021 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2022#################################
Dementia_2022_i <- ms_i_2022 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
Dementia_2022_o <- ms_o_2022 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia_2022_s <- ms_s_2022 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
Dementia <- bind_rows(Dementia_2006_i, Dementia_2006_o, Dementia_2006_s, Dementia_2007_i, Dementia_2007_o, Dementia_2007_s, Dementia_2008_i, Dementia_2008_o, Dementia_2008_s, Dementia_2009_i, Dementia_2009_o, Dementia_2009_s, Dementia_2010_i, Dementia_2010_o, Dementia_2010_s, Dementia_2011_i, Dementia_2011_o, Dementia_2011_s, Dementia_2012_i, Dementia_2012_o, Dementia_2012_s, Dementia_2013_i, Dementia_2013_o, Dementia_2013_s, Dementia_2014_i, Dementia_2014_o, Dementia_2014_s, Dementia_2015_i, Dementia_2015_o, Dementia_2015_s, Dementia_2016_i, Dementia_2016_o, Dementia_2016_s, Dementia_2017_i, Dementia_2017_o, Dementia_2017_s, Dementia_2018_i, Dementia_2018_o, Dementia_2018_s, Dementia_2019_i, Dementia_2019_o, Dementia_2019_s, Dementia_2020_i, Dementia_2020_o, Dementia_2020_s, Dementia_2021_i, Dementia_2021_o, Dementia_2021_s, Dementia_2022_i, Dementia_2022_o, Dementia_2022_s) %>% 
  group_by(ENROLID) %>% 
  mutate(any_dementia = sum(dementia_diagnosis)) %>% 
  distinct(ENROLID, .keep_all=TRUE) %>% 
  mutate(dementia = case_when(
    any_dementia==0 ~ 0, 
    TRUE ~ 1)) %>% 
  select(ENROLID, dementia) %>% 
  collect()
```
...
Determination of patients with chronic respiratory failure
```{r}
# Chronic respiratory failure codes
codes_chronic_respiratory_failure_ICD9 <- c("51883", "51884")

codes_chronic_respiratory_failure_ICD10 <- c("J961", "J9610", "J9611", "J9612", "J962", "J9620", "J9621", "J9622")
...
#################################2006#################################
chronic_respiratory_failure_2006_i <- ms_i_2006 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
  mutate(chronic_respiratory_failure_diagnosis = case_when(
  ((DX1 %in% codes_chronic_respiratory_failure_ICD9) | (DX2 %in% codes_chronic_respiratory_failure_ICD9) | (DX3 %in% codes_chronic_respiratory_failure_ICD9) | (DX4 %in% codes_chronic_respiratory_failure_ICD9) | (DX5 %in% codes_chronic_respiratory_failure_ICD9) | (DX6 %in% codes_chronic_respiratory_failure_ICD9) | (DX7 %in% codes_chronic_respiratory_failure_ICD9) | (DX8 %in% codes_chronic_respiratory_failure_ICD9) | (DX9 %in% codes_chronic_respiratory_failure_ICD9) | (DX10 %in% codes_chronic_respiratory_failure_ICD9) | (DX11 %in% codes_chronic_respiratory_failure_ICD9) | (DX12 %in% codes_chronic_respiratory_failure_ICD9) | (DX13 %in% codes_chronic_respiratory_failure_ICD9) | (DX14 %in% codes_chronic_respiratory_failure_ICD9) | (DX15 %in% codes_chronic_respiratory_failure_ICD9))~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  select(ENROLID, SVCDATE, chronic_respiratory_failure_diagnosis)

chronic_respiratory_failure_2006_o <- ms_o_2006 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
  mutate(chronic_respiratory_failure_diagnosis = case_when(
  ((DX1 %in% codes_chronic_respiratory_failure_ICD9) | (DX2 %in% codes_chronic_respiratory_failure_ICD9)) ~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  select(ENROLID, SVCDATE, chronic_respiratory_failure_diagnosis)

chronic_respiratory_failure_2006_s <- ms_s_2006 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2007#################################
chronic_respiratory_failure_2007_i <- ms_i_2007 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2007_o <- ms_o_2007 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2007_s <- ms_s_2007 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2008#################################
chronic_respiratory_failure_2008_i <- ms_i_2008 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2008_o <- ms_o_2008 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2008_s <- ms_s_2008 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2009#################################
chronic_respiratory_failure_2009_i <- ms_i_2009 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2009_o <- ms_o_2009 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2009_s <- ms_s_2009 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2010#################################
chronic_respiratory_failure_2010_i <- ms_i_2010 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2010_o <- ms_o_2010 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2010_s <- ms_s_2010 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2011#################################
chronic_respiratory_failure_2011_i <- ms_i_2011 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2011_o <- ms_o_2011 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2011_s <- ms_s_2011 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2012#################################
chronic_respiratory_failure_2012_i <- ms_i_2012 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2012_o <- ms_o_2012 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2012_s <- ms_s_2012 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2013#################################
chronic_respiratory_failure_2013_i <- ms_i_2013 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2013_o <- ms_o_2013 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2013_s <- ms_s_2013 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2014#################################
chronic_respiratory_failure_2014_i <- ms_i_2014 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2014_o <- ms_o_2014 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2014_s <- ms_s_2014 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2015#################################
chronic_respiratory_failure_2015_i <- ms_i_2015 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
  mutate(chronic_respiratory_failure_diagnosis = case_when(
  ((DX1 %in% codes_chronic_respiratory_failure_ICD9) | (DX2 %in% codes_chronic_respiratory_failure_ICD9) | (DX3 %in% codes_chronic_respiratory_failure_ICD9) | (DX4 %in% codes_chronic_respiratory_failure_ICD9) | (DX5 %in% codes_chronic_respiratory_failure_ICD9) | (DX6 %in% codes_chronic_respiratory_failure_ICD9) | (DX7 %in% codes_chronic_respiratory_failure_ICD9) | (DX8 %in% codes_chronic_respiratory_failure_ICD9) | (DX9 %in% codes_chronic_respiratory_failure_ICD9) | (DX10 %in% codes_chronic_respiratory_failure_ICD9) | (DX11 %in% codes_chronic_respiratory_failure_ICD9) | (DX12 %in% codes_chronic_respiratory_failure_ICD9) | (DX13 %in% codes_chronic_respiratory_failure_ICD9) | (DX14 %in% codes_chronic_respiratory_failure_ICD9) | (DX15 %in% codes_chronic_respiratory_failure_ICD9) | (DX1 %in% codes_chronic_respiratory_failure_ICD10) | (DX2 %in% codes_chronic_respiratory_failure_ICD10) | (DX3 %in% codes_chronic_respiratory_failure_ICD10) | (DX4 %in% codes_chronic_respiratory_failure_ICD10) | (DX5 %in% codes_chronic_respiratory_failure_ICD10) | (DX6 %in% codes_chronic_respiratory_failure_ICD10) | (DX7 %in% codes_chronic_respiratory_failure_ICD10) | (DX8 %in% codes_chronic_respiratory_failure_ICD10) | (DX9 %in% codes_chronic_respiratory_failure_ICD10) | (DX10 %in% codes_chronic_respiratory_failure_ICD10) | (DX11 %in% codes_chronic_respiratory_failure_ICD10) | (DX12 %in% codes_chronic_respiratory_failure_ICD10) | (DX13 %in% codes_chronic_respiratory_failure_ICD10) | (DX14 %in% codes_chronic_respiratory_failure_ICD10) | (DX15 %in% codes_chronic_respiratory_failure_ICD10)) ~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  select(ENROLID, SVCDATE, chronic_respiratory_failure_diagnosis)

chronic_respiratory_failure_2015_o <- ms_o_2015 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
  mutate(chronic_respiratory_failure_diagnosis = case_when(
  ((DX1 %in% codes_chronic_respiratory_failure_ICD9) | (DX2 %in% codes_chronic_respiratory_failure_ICD9) | (DX1 %in% codes_chronic_respiratory_failure_ICD10) | (DX2 %in% codes_chronic_respiratory_failure_ICD10)) ~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  select(ENROLID, SVCDATE, chronic_respiratory_failure_diagnosis)

chronic_respiratory_failure_2015_s <- ms_s_2015 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2016#################################
chronic_respiratory_failure_2016_i <- ms_i_2016 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
  mutate(chronic_respiratory_failure_diagnosis = case_when(
  ((DX1 %in% codes_chronic_respiratory_failure_ICD10) | (DX2 %in% codes_chronic_respiratory_failure_ICD10) | (DX3 %in% codes_chronic_respiratory_failure_ICD10) | (DX4 %in% codes_chronic_respiratory_failure_ICD10) | (DX5 %in% codes_chronic_respiratory_failure_ICD10) | (DX6 %in% codes_chronic_respiratory_failure_ICD10) | (DX7 %in% codes_chronic_respiratory_failure_ICD10) | (DX8 %in% codes_chronic_respiratory_failure_ICD10) | (DX9 %in% codes_chronic_respiratory_failure_ICD10) | (DX10 %in% codes_chronic_respiratory_failure_ICD10) | (DX11 %in% codes_chronic_respiratory_failure_ICD10) | (DX12 %in% codes_chronic_respiratory_failure_ICD10) | (DX13 %in% codes_chronic_respiratory_failure_ICD10) | (DX14 %in% codes_chronic_respiratory_failure_ICD10) | (DX15 %in% codes_chronic_respiratory_failure_ICD10))~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  select(ENROLID, SVCDATE, chronic_respiratory_failure_diagnosis)

chronic_respiratory_failure_2016_o <- ms_o_2016 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
  mutate(chronic_respiratory_failure_diagnosis = case_when(
  ((DX1 %in% codes_chronic_respiratory_failure_ICD10) | (DX2 %in% codes_chronic_respiratory_failure_ICD10)) ~ 1,
  TRUE ~ 0)) %>% 
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  select(ENROLID, SVCDATE, chronic_respiratory_failure_diagnosis)

chronic_respiratory_failure_2016_s <- ms_s_2016 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2017#################################
chronic_respiratory_failure_2017_i <- ms_i_2017 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2017_o <- ms_o_2017 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2017_s <- ms_s_2017 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2018#################################
chronic_respiratory_failure_2018_i <- ms_i_2018 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2018_o <- ms_o_2018 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2018_s <- ms_s_2018 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2019#################################
chronic_respiratory_failure_2019_i <- ms_i_2019 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2019_o <- ms_o_2019 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2019_s <- ms_s_2019 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2020#################################
chronic_respiratory_failure_2020_i <- ms_i_2020 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2020_o <- ms_o_2020 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2020_s <- ms_s_2020 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2021#################################
chronic_respiratory_failure_2021_i <- ms_i_2021 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2021_o <- ms_o_2021 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2021_s <- ms_s_2021 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
#################################2022#################################
chronic_respiratory_failure_2022_i <- ms_i_2022 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9, DX10, DX11, DX12, DX13, DX14, DX15, ADMDATE) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%  
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>%    
  mutate(SVCDATE=ADMDATE) %>%
...
chronic_respiratory_failure_2022_o <- ms_o_2022 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PROC1, STDPLAC, REVCODE, SVCSCAT, PROCGRP) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
chronic_respiratory_failure_2022_s <- ms_s_2022 %>% select(ENROLID, AGE, SEX, DX1, DX2, SVCDATE, PPROC, PROC1, STDPLAC, REVCODE, SVCSCAT) %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>% 
  mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
  filter(ENROLID>0) %>% 
  distinct(ENROLID, SVCDATE, .keep_all=TRUE) %>% 
...
# Patients with chronic_respiratory_failure diagnosis
chronic_respiratory_failure <- bind_rows(chronic_respiratory_failure_2006_i, chronic_respiratory_failure_2006_o, chronic_respiratory_failure_2006_s, chronic_respiratory_failure_2007_i, chronic_respiratory_failure_2007_o, chronic_respiratory_failure_2007_s, chronic_respiratory_failure_2008_i, chronic_respiratory_failure_2008_o, chronic_respiratory_failure_2008_s, chronic_respiratory_failure_2009_i, chronic_respiratory_failure_2009_o, chronic_respiratory_failure_2009_s, chronic_respiratory_failure_2010_i, chronic_respiratory_failure_2010_o, chronic_respiratory_failure_2010_s, chronic_respiratory_failure_2011_i, chronic_respiratory_failure_2011_o, chronic_respiratory_failure_2011_s, chronic_respiratory_failure_2012_i, chronic_respiratory_failure_2012_o, chronic_respiratory_failure_2012_s, chronic_respiratory_failure_2013_i, chronic_respiratory_failure_2013_o, chronic_respiratory_failure_2013_s, chronic_respiratory_failure_2014_i, chronic_respiratory_failure_2014_o, chronic_respiratory_failure_2014_s, chronic_respiratory_failure_2015_i, chronic_respiratory_failure_2015_o, chronic_respiratory_failure_2015_s, chronic_respiratory_failure_2016_i, chronic_respiratory_failure_2016_o, chronic_respiratory_failure_2016_s, chronic_respiratory_failure_2017_i, chronic_respiratory_failure_2017_o, chronic_respiratory_failure_2017_s, chronic_respiratory_failure_2018_i, chronic_respiratory_failure_2018_o, chronic_respiratory_failure_2018_s, chronic_respiratory_failure_2019_i, chronic_respiratory_failure_2019_o, chronic_respiratory_failure_2019_s, chronic_respiratory_failure_2020_i, chronic_respiratory_failure_2020_o, chronic_respiratory_failure_2020_s, chronic_respiratory_failure_2021_i, chronic_respiratory_failure_2021_o, chronic_respiratory_failure_2021_s, chronic_respiratory_failure_2022_i, chronic_respiratory_failure_2022_o, chronic_respiratory_failure_2022_s) %>% 
  group_by(ENROLID) %>% 
  mutate(any_chronic_respiratory_failure = sum(chronic_respiratory_failure_diagnosis)) %>% 
  distinct(ENROLID, .keep_all=TRUE) %>% 
  mutate(chronic_respiratory_failure = case_when(
    any_chronic_respiratory_failure==0 ~ 0, 
    TRUE ~ 1)) %>% 
  select(ENROLID, chronic_respiratory_failure) %>% 
  collect()
```
...
Patients with epilepsy and at least one rescue medication prescribed
```{r}
# Rescue medications
...
# Proportion of patients with rescue medication among patients with epilepsy
rescue_medication_patients_n / epilepsy_n
```
...
demographics_2006 <- ms_t_2006 %>% 
  filter(ENROLID %in% !!epilepsy$ENROLID) %>%
  select(ENROLID, SEX, DOBYR, REGION, EECLASS, EESTATU, EMPREL, EGEOLOC, DTSTART, DTEND, MEMDAYS, MSA, INDSTRY) %>% 
...
demographics <- demographics %>% 
  group_by(ENROLID) %>% 
  arrange(ENROLID, SVCDATE) %>% 
  mutate(person_years = as.numeric(((dplyr::last(SVCDATE)) - dplyr::first(SVCDATE))/ 365.24219)) %>% 
  ungroup() %>% 
  collect() 
...
demographics <- demographics %>% 
  ...
  arrange(ENROLID, SVCDATE) %>% 
  mutate(person_years_per_year = as.numeric(((dplyr::last(SVCDATE)) - dplyr::first(SVCDATE))/ 365.24219)) %>% 
  ungroup() %>% 
  collect() 
...
# Eliminate patients with less than 2 person years of follow-up
demographics <- demographics %>% 
  filter(person_years >= 2) %>% 
  collect()
...
demographics <- demographics %>% 
  mutate(age_groups = case_when(
    ...
    (age_first_ASM_prescription > 50 & age_first_ASM_prescription <= 60) ~ "51-60 years",
    (age_first_ASM_prescription > 60) ~ "> 60 years",
    TRUE ~ "no data"
  )) %>% 
  collect()
...
# Incorporate variable dementia
demographics <- demographics %>% 
  left_join(Dementia, by="ENROLID") %>% 
  collect()




# Incorporate variable chronic respiratory failure
demographics <- demographics %>% 
  left_join(chronic_respiratory_failure, by="ENROLID") %>% 
  collect()
...
# Dementia
dementia_comorbidity <- demographics %>% 
  arrange(ENROLID, SVCDATE) %>% 
  distinct(ENROLID, .keep_all=TRUE) %>% 
  reframe(
    dementia_comorbidity = CrossTable(dementia)
  )

dementia_comorbidity_with_rescue_medication <- demographics_with_rescue_medication %>% 
  arrange(ENROLID, SVCDATE) %>% 
  distinct(ENROLID, .keep_all=TRUE) %>% 
  reframe(
    dementia_comorbidity = CrossTable(dementia)
...
dementia_comorbidity_without_rescue_medication <- demographics_without_rescue_medication %>% 
  arrange(ENROLID, SVCDATE) %>% 
  distinct(ENROLID, .keep_all=TRUE) %>% 
  reframe(
    dementia_comorbidity = CrossTable(dementia)
...
# Chronic respiratory failure
chronic_respiratory_failure_comorbidity <- demographics %>% 
  arrange(ENROLID, SVCDATE) %>% 
  distinct(ENROLID, .keep_all=TRUE) %>% 
  reframe(
    chronic_respiratory_failure_comorbidity = CrossTable(chronic_respiratory_failure)
  )

chronic_respiratory_failure_comorbidity_with_rescue_medication <- demographics_with_rescue_medication %>% 
  arrange(ENROLID, SVCDATE) %>% 
  distinct(ENROLID, .keep_all=TRUE) %>% 
  reframe(
    chronic_respiratory_failure_comorbidity = CrossTable(chronic_respiratory_failure)
...
chronic_respiratory_failure_comorbidity_without_rescue_medication <- demographics_without_rescue_medication %>% 
  arrange(ENROLID, SVCDATE) %>% 
  distinct(ENROLID, .keep_all=TRUE) %>% 
  reframe(
    chronic_respiratory_failure_comorbidity = CrossTable(chronic_respiratory_failure)
...
rural_residence <- demographics %>% 
  arrange(ENROLID, SVCDATE) %>% 
  distinct(ENROLID, .keep_all=TRUE) %>% 
  reframe(
    rural_residence = CrossTable(rural)
  )

rural_residence_with_rescue_medication <- demographics_with_rescue_medication %>% 
  arrange(ENROLID, SVCDATE) %>% 
  distinct(ENROLID, .keep_all=TRUE) %>% 
  reframe(
    rural_residence = CrossTable(rural)
...
rural_residence_without_rescue_medication <- demographics_without_rescue_medication %>% 
  arrange(ENROLID, SVCDATE) %>% 
  distinct(ENROLID, .keep_all=TRUE) %>% 
  reframe(
    rural_residence = CrossTable(rural)
...
proportion_with_rescue_medication_per_year <- proportion_with_rescue_medication_per_year[proportion_with_rescue_medication_per_year$year %in% 2006:2022, ]
...
proportion_with_rescue_medication_per_year_by_age_groups <- proportion_with_rescue_medication_per_year_by_age_groups[proportion_with_rescue_medication_per_year_by_age_groups$year %in% 2006:2022, ]
...
jonckheere_proportion_with_rescue_medication_per_year_by_age_groups_51_60_y_p_value <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_age_groups[proportion_with_rescue_medication_per_year_by_age_groups$age_groups=="51-60 years", ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_age_groups_51_60_y_p_value


jonckheere_proportion_with_rescue_medication_per_year_by_age_groups_51_60_y_p_value_2018_2022 <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_age_groups[proportion_with_rescue_medication_per_year_by_age_groups$age_groups=="51-60 years" & proportion_with_rescue_medication_per_year_by_age_groups$year>=2018, ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_age_groups_51_60_y_p_value_2018_2022




jonckheere_proportion_with_rescue_medication_per_year_by_age_groups_more_than_60_y_p_value <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_age_groups[proportion_with_rescue_medication_per_year_by_age_groups$age_groups=="> 60 years", ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_age_groups_more_than_60_y_p_value


jonckheere_proportion_with_rescue_medication_per_year_by_age_groups_more_than_60_y_p_value_2018_2022 <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_age_groups[proportion_with_rescue_medication_per_year_by_age_groups$age_groups=="> 60 years" & proportion_with_rescue_medication_per_year_by_age_groups$year>=2018, ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_age_groups_more_than_60_y_p_value_2018_2022
...
proportion_with_rescue_medication_per_year_by_refractory_epilepsy <- proportion_with_rescue_medication_per_year_by_refractory_epilepsy[proportion_with_rescue_medication_per_year_by_refractory_epilepsy$year %in% 2006:2022, ]
...
proportion_with_rescue_medication_per_year_by_IP_ED_epilepsy_visits <- proportion_with_rescue_medication_per_year_by_IP_ED_epilepsy_visits[proportion_with_rescue_medication_per_year_by_IP_ED_epilepsy_visits$year %in% 2006:2022, ]
...
#################################By dementia#################################
# Proportion of patients with rescue medication
proportion_patients_with_rescue_medication_by_dementia <- demographics %>% 
  distinct(ENROLID, dementia) %>% 
  mutate(with_rescue_medication = case_when(
    ENROLID %in% !!inflation_adjusted_rescue_medication_epilepsy$ENROLID ~ "rescue_medicaton",
    TRUE ~ "no rescue medication"
  )) %>% 
  group_by(dementia) %>%
  mutate(patients_with_rescue_medication_per_dementia = sum(with_rescue_medication=="rescue_medicaton"),
         total_patients_per_dementia = n(),
         proportion_patients_with_rescue_medication_per_dementia = patients_with_rescue_medication_per_dementia / total_patients_per_dementia) %>%
    distinct(dementia, .keep_all=TRUE) %>% 
    select(patients_with_rescue_medication_per_dementia, total_patients_per_dementia, proportion_patients_with_rescue_medication_per_dementia) %>% 
  collect()
proportion_patients_with_rescue_medication_by_dementia

proportion_with_rescue_medication_per_year_by_dementia <- demographics %>% 
  distinct(ENROLID, year_ASM, dementia) %>% 
  left_join(inflation_adjusted_rescue_medication_epilepsy, join_by(ENROLID, year_ASM == year_rescue_medication)) %>% 
  rename(year=year_ASM) %>% 
  distinct(ENROLID, year, .keep_all=TRUE) %>% 
  group_by(year, dementia) %>% 
  mutate(patients_with_rescue_medication_per_year = sum(!is.na(rescue_medication)),
         total_patients_per_year = n(),
         proportion_patients_with_rescue_medication_per_year = patients_with_rescue_medication_per_year / total_patients_per_year) %>% 
  distinct(year, .keep_all=TRUE) %>% 
  arrange(year, dementia) %>% 
  select(year, patients_with_rescue_medication_per_year, total_patients_per_year, proportion_patients_with_rescue_medication_per_year) %>% 
  collect()
proportion_with_rescue_medication_per_year_by_dementia

proportion_with_rescue_medication_per_year_by_dementia <- proportion_with_rescue_medication_per_year_by_dementia[proportion_with_rescue_medication_per_year_by_dementia$year %in% 2006:2022, ]




# Jonckheere Terpstra test
jonckheere_proportion_with_rescue_medication_per_year_by_dementia_dementia_p_value <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_dementia[proportion_with_rescue_medication_per_year_by_dementia$dementia==1, ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_dementia_dementia_p_value


jonckheere_proportion_with_rescue_medication_per_year_by_dementia_dementia_p_value_2018_2022 <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_dementia[proportion_with_rescue_medication_per_year_by_dementia$dementia==1 & proportion_with_rescue_medication_per_year_by_dementia$year>=2018, ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_dementia_dementia_p_value_2018_2022




jonckheere_proportion_with_rescue_medication_per_year_by_dementia_no_dementia_p_value <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_dementia[proportion_with_rescue_medication_per_year_by_dementia$dementia==0, ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_dementia_no_dementia_p_value


jonckheere_proportion_with_rescue_medication_per_year_by_dementia_no_dementia_p_value_2018_2022 <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_dementia[proportion_with_rescue_medication_per_year_by_dementia$dementia==0 & proportion_with_rescue_medication_per_year_by_dementia$year>=2018, ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_dementia_no_dementia_p_value_2018_2022




# Proportion of patients with at least one rescue medication prescription per year by dementia figure
proportion_with_rescue_medication_per_year_by_dementia_plot <- ggplot(data=proportion_with_rescue_medication_per_year_by_dementia,
                                aes(x=year, y=proportion_patients_with_rescue_medication_per_year, color=factor(dementia))) + 
  scale_color_manual(values = c("0" = "aquamarine4", 
                                "1" = "gray57")) +
  geom_line(lwd=1.5) + 
  theme(legend.position="none", panel.background=element_blank(), panel.grid.major=element_blank(), panel.grid.minor=element_blank(), panel.border=element_blank(), axis.ticks=element_blank(),
        axis.text=element_text(size=14, face="bold"), axis.text.x=element_text(angle=45, hjust=1),
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 1, 0.1), limits = c(0, 1))
proportion_with_rescue_medication_per_year_by_dementia_plot


proportion_with_rescue_medication_per_year_by_dementia_plot_detail <- ggplot(data=proportion_with_rescue_medication_per_year_by_dementia,
                                aes(x=year, y=proportion_patients_with_rescue_medication_per_year, color=factor(dementia))) + 
  scale_color_manual(values = c("0" = "aquamarine4", 
                                "1" = "gray57")) +
  geom_line(lwd=1.5) + 
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 0.3, 0.1), limits = c(0, 0.3))
proportion_with_rescue_medication_per_year_by_dementia_plot_detail




#################################By chronic respiratory failure#################################
# Proportion of patients with rescue medication
proportion_patients_with_rescue_medication_by_chronic_respiratory_failure <- demographics %>% 
  distinct(ENROLID, chronic_respiratory_failure) %>% 
  mutate(with_rescue_medication = case_when(
    ENROLID %in% !!inflation_adjusted_rescue_medication_epilepsy$ENROLID ~ "rescue_medicaton",
    TRUE ~ "no rescue medication"
  )) %>% 
  group_by(chronic_respiratory_failure) %>%
  mutate(patients_with_rescue_medication_per_chronic_respiratory_failure = sum(with_rescue_medication=="rescue_medicaton"),
         total_patients_per_chronic_respiratory_failure = n(),
         proportion_patients_with_rescue_medication_per_chronic_respiratory_failure = patients_with_rescue_medication_per_chronic_respiratory_failure / total_patients_per_chronic_respiratory_failure) %>%
    distinct(chronic_respiratory_failure, .keep_all=TRUE) %>% 
    select(patients_with_rescue_medication_per_chronic_respiratory_failure, total_patients_per_chronic_respiratory_failure, proportion_patients_with_rescue_medication_per_chronic_respiratory_failure) %>% 
  collect()
proportion_patients_with_rescue_medication_by_chronic_respiratory_failure

proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure <- demographics %>% 
  distinct(ENROLID, year_ASM, chronic_respiratory_failure) %>% 
  left_join(inflation_adjusted_rescue_medication_epilepsy, join_by(ENROLID, year_ASM == year_rescue_medication)) %>% 
  rename(year=year_ASM) %>% 
  distinct(ENROLID, year, .keep_all=TRUE) %>% 
  group_by(year, chronic_respiratory_failure) %>% 
  mutate(patients_with_rescue_medication_per_year = sum(!is.na(rescue_medication)),
         total_patients_per_year = n(),
         proportion_patients_with_rescue_medication_per_year = patients_with_rescue_medication_per_year / total_patients_per_year) %>% 
  distinct(year, .keep_all=TRUE) %>% 
  arrange(year, chronic_respiratory_failure) %>% 
  select(year, patients_with_rescue_medication_per_year, total_patients_per_year, proportion_patients_with_rescue_medication_per_year) %>% 
  collect()
proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure

proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure <- proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure[proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure$year %in% 2006:2022, ]




# Jonckheere Terpstra test
jonckheere_proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_chronic_respiratory_failure_p_value <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure[proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure$chronic_respiratory_failure==1, ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_chronic_respiratory_failure_p_value


jonckheere_proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_chronic_respiratory_failure_p_value_2018_2022 <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure[proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure$chronic_respiratory_failure==1 & proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure$year>=2018, ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_chronic_respiratory_failure_p_value_2018_2022




jonckheere_proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_no_chronic_respiratory_failure_p_value <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure[proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure$chronic_respiratory_failure==0, ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_no_chronic_respiratory_failure_p_value


jonckheere_proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_no_chronic_respiratory_failure_p_value_2018_2022 <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure[proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure$chronic_respiratory_failure==0 & proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure$year>=2018, ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_no_chronic_respiratory_failure_p_value_2018_2022




# Proportion of patients with at least one rescue medication prescription per year by chronic respiratory failurea figure
proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_plot <- ggplot(data=proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure,
                                aes(x=year, y=proportion_patients_with_rescue_medication_per_year, color=factor(chronic_respiratory_failure))) + 
  scale_color_manual(values = c("0" = "orchid4", 
                                "1" = "khaki4")) +
  geom_line(lwd=1.5) + 
  theme(legend.position="none", panel.background=element_blank(), panel.grid.major=element_blank(), panel.grid.minor=element_blank(), panel.border=element_blank(), axis.ticks=element_blank(),
        axis.text=element_text(size=14, face="bold"), axis.text.x=element_text(angle=45, hjust=1),
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 1, 0.1), limits = c(0, 1))
proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_plot


proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_plot_detail <- ggplot(data=proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure,
                                aes(x=year, y=proportion_patients_with_rescue_medication_per_year, color=factor(chronic_respiratory_failure))) + 
  scale_color_manual(values = c("0" = "orchid4", 
                                "1" = "khaki4")) +
  geom_line(lwd=1.5) + 
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 0.3, 0.1), limits = c(0, 0.3))
proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_plot_detail
...
#################################By rural#################################
# Proportion of patients with rescue medication
proportion_patients_with_rescue_medication_by_rural <- demographics %>% 
  distinct(ENROLID, rural) %>% 
  mutate(with_rescue_medication = case_when(
    ENROLID %in% !!inflation_adjusted_rescue_medication_epilepsy$ENROLID ~ "rescue_medicaton",
    TRUE ~ "no rescue medication"
  )) %>% 
  group_by(rural) %>%
  mutate(patients_with_rescue_medication_per_rural = sum(with_rescue_medication=="rescue_medicaton"),
         total_patients_per_rural = n(),
         proportion_patients_with_rescue_medication_per_rural = patients_with_rescue_medication_per_rural / total_patients_per_rural) %>%
    distinct(rural, .keep_all=TRUE) %>% 
    select(patients_with_rescue_medication_per_rural, total_patients_per_rural, proportion_patients_with_rescue_medication_per_rural) %>% 
  collect()
proportion_patients_with_rescue_medication_by_rural

proportion_with_rescue_medication_per_year_by_rural <- demographics %>% 
  distinct(ENROLID, year_ASM, rural) %>% 
  left_join(inflation_adjusted_rescue_medication_epilepsy, join_by(ENROLID, year_ASM == year_rescue_medication)) %>% 
  rename(year=year_ASM) %>% 
  distinct(ENROLID, year, .keep_all=TRUE) %>% 
  group_by(year, rural) %>% 
  ...
  select(year, patients_with_rescue_medication_per_year, total_patients_per_year, proportion_patients_with_rescue_medication_per_year) %>% 
  collect()
proportion_with_rescue_medication_per_year_by_rural

proportion_with_rescue_medication_per_year_by_rural <- proportion_with_rescue_medication_per_year_by_rural[proportion_with_rescue_medication_per_year_by_rural$year %in% 2006:2022, ]




# Jonckheere Terpstra test
jonckheere_proportion_with_rescue_medication_per_year_by_rural_rural_p_value <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_rural[proportion_with_rescue_medication_per_year_by_rural$rural=="yes", ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_rural_rural_p_value


jonckheere_proportion_with_rescue_medication_per_year_by_rural_rural_p_value_2018_2022 <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_rural[proportion_with_rescue_medication_per_year_by_rural$rural=="yes" & proportion_with_rescue_medication_per_year_by_rural$year>=2018, ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_rural_rural_p_value_2018_2022




jonckheere_proportion_with_rescue_medication_per_year_by_rural_urban_p_value <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_rural[proportion_with_rescue_medication_per_year_by_rural$rural=="no", ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_rural_urban_p_value


jonckheere_proportion_with_rescue_medication_per_year_by_rural_urban_p_value_2018_2022 <- JonckheereTerpstraTest(proportion_patients_with_rescue_medication_per_year ~ year, data=proportion_with_rescue_medication_per_year_by_rural[proportion_with_rescue_medication_per_year_by_rural$rural=="no" & proportion_with_rescue_medication_per_year_by_rural$year>=2018, ], alternative="increasing")$p.value
jonckheere_proportion_with_rescue_medication_per_year_by_rural_urban_p_value_2018_2022




# Proportion of patients with at least one rescue medication prescription per year by rural figure
proportion_with_rescue_medication_per_year_by_rural_plot <- ggplot(data=proportion_with_rescue_medication_per_year_by_rural,
                                aes(x=year, y=proportion_patients_with_rescue_medication_per_year, color=rural)) + 
  scale_color_manual(values = c("no" = "hotpink4", 
                                "yes" = "azure4")) +
  geom_line(lwd=1.5) + 
  theme(legend.position="none", panel.background=element_blank(), panel.grid.major=element_blank(), panel.grid.minor=element_blank(), panel.border=element_blank(), axis.ticks=element_blank(),
        axis.text=element_text(size=14, face="bold"), axis.text.x=element_text(angle=45, hjust=1),
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 1, 0.1), limits = c(0, 1))
proportion_with_rescue_medication_per_year_by_rural_plot


proportion_with_rescue_medication_per_year_by_rural_plot_detail <- ggplot(data=proportion_with_rescue_medication_per_year_by_rural,
                                aes(x=year, y=proportion_patients_with_rescue_medication_per_year, color=rural)) + 
  scale_color_manual(values = c("no" = "hotpink4", 
                                "yes" = "azure4")) +
  geom_line(lwd=1.5) + 
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 0.3, 0.1), limits = c(0, 0.3))
proportion_with_rescue_medication_per_year_by_rural_plot_detail
```
...
logistic_regression_database <- demographics %>% 
  ...
  mutate(  
    ...
    chronic_respiratory_failure = as.factor(chronic_respiratory_failure)
  ) %>% 
  select(ENROLID, age_groups, male, refractory, ED_IP_1_3, ED_IP_more_than_3, north_east, north_central, south, other_region, full_time, dementia, chronic_respiratory_failure, rural) %>% 
  mutate(rescue = case_when(
    ENROLID %in% !!inflation_adjusted_rescue_medication_epilepsy$ENROLID ~ 1,
    TRUE ~ 0)
    ) %>% 
  select(ENROLID, rescue, age_groups, male, refractory, ED_IP_1_3, ED_IP_more_than_3, north_east, north_central, south, other_region, full_time, dementia, chronic_respiratory_failure, rural) %>% 
  collect()
...
# Logistic regression
rescue_medication_logistic_regression <- glm(rescue ~ relevel(age_groups, ref="13-21 years") + male + refractory + ED_IP_1_3 + ED_IP_more_than_3 + north_east + north_central + south + other_region + full_time + dementia + chronic_respiratory_failure + rural, data=logistic_regression_database, family="binomial")
...
rescue_medication_logistic_regression_age_more_than_60_y_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[2, 4]

rescue_medication_logistic_regression_age_0_5_y_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[3, 4]

rescue_medication_logistic_regression_age_22_35_y_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[4, 4]

rescue_medication_logistic_regression_age_36_50_y_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[5, 4]

rescue_medication_logistic_regression_age_51_60_y_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[6, 4]

rescue_medication_logistic_regression_age_6_12_y_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[7, 4]

rescue_medication_logistic_regression_male_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[8, 4]

rescue_medication_logistic_regression_refractory_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[9, 4]

rescue_medication_logistic_regression_ED_IP_1_3_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[10, 4]

rescue_medication_logistic_regression_ED_IP_more_than_3_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[11, 4]

rescue_medication_logistic_regression_north_east_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[12, 4]

rescue_medication_logistic_regression_north_central_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[13, 4]

rescue_medication_logistic_regression_south_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[14, 4]

rescue_medication_logistic_regression_other_region_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[15, 4]

rescue_medication_logistic_regression_full_time_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[16, 4]

rescue_medication_logistic_regression_dementia_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[17, 4]

rescue_medication_logistic_regression_chronic_respiratory_failure_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[18, 4]

rescue_medication_logistic_regression_rural_p_value <- summary(rescue_medication_logistic_regression, digits=1000)$coefficients[19, 4]
```
...
rescue_medication_use_per_year_by_age_group_51_60_years_plot <- ggplot(data=rescue_medication_use_per_year_by_age_groups[rescue_medication_use_per_year_by_age_groups$age_groups=="51-60 years", ],
                                aes(x=`year(SVCDATE)`, y=proportion_use_per_year, color=rescue_medication)) + 
  scale_color_manual(values = c("rectal diazepam" = "red",
                                "intranasal midazolam"="purple4",
                                "intranasal diazepam"="greenyellow")) +
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 1, 0.2), limits = c(0, 1))
rescue_medication_use_per_year_by_age_group_51_60_years_plot




rescue_medication_use_per_year_by_age_group_above_60_years_plot <- ggplot(data=rescue_medication_use_per_year_by_age_groups[rescue_medication_use_per_year_by_age_groups$age_groups=="> 60 years", ],
                                aes(x=`year(SVCDATE)`, y=proportion_use_per_year, color=rescue_medication)) + 
  scale_color_manual(values = c("rectal diazepam" = "red",
                                "intranasal midazolam"="purple4",
                                "intranasal diazepam"="greenyellow")) +
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 1, 0.2), limits = c(0, 1))
rescue_medication_use_per_year_by_age_group_above_60_years_plot
...
#################################By dementia#################################
# Use of rescue medication per year
demographics_dementia <- demographics[ , c("ENROLID", "dementia")] %>% 
  distinct(ENROLID, dementia) %>% 
  collect()

rescue_medication_use_per_year_by_dementia  <- inflation_adjusted_rescue_medication_epilepsy %>% 
  left_join(demographics_dementia, by="ENROLID") %>% 
  filter(!is.na(dementia)) %>% 
  group_by(year(SVCDATE), dementia) %>% 
  mutate(total_rescue_medication_prescriptions_per_year = n()) %>% 
  ungroup() %>% 
  group_by(year(SVCDATE), dementia, rescue_medication) %>% 
  summarize(
    proportion_use_per_year = n() / total_rescue_medication_prescriptions_per_year
  ) %>% 
  distinct(`year(SVCDATE)`, dementia, rescue_medication, .keep_all=TRUE) %>% 
  ungroup() %>% 
  group_by(`year(SVCDATE)`, dementia) %>% 
  arrange(desc(proportion_use_per_year), .by_group=TRUE) %>% 
  collect()
rescue_medication_use_per_year_by_dementia




# Use of rescue medication per year figure
rescue_medication_use_per_year_by_dementia_dementia_plot <- ggplot(data=rescue_medication_use_per_year_by_dementia[rescue_medication_use_per_year_by_dementia$dementia==1, ],
                                aes(x=`year(SVCDATE)`, y=proportion_use_per_year, color=rescue_medication)) + 
  scale_color_manual(values = c("rectal diazepam" = "red",
                                "intranasal midazolam"="purple4",
                                "intranasal diazepam"="greenyellow")) +
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 1, 0.2), limits = c(0, 1))
rescue_medication_use_per_year_by_dementia_dementia_plot




rescue_medication_use_per_year_by_dementia_no_dementia_plot <- ggplot(data=rescue_medication_use_per_year_by_dementia[rescue_medication_use_per_year_by_dementia$dementia==0, ],
                                aes(x=`year(SVCDATE)`, y=proportion_use_per_year, color=rescue_medication)) + 
  scale_color_manual(values = c("rectal diazepam" = "red",
                                "intranasal midazolam"="purple4",
                                "intranasal diazepam"="greenyellow")) +
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 1, 0.2), limits = c(0, 1))
rescue_medication_use_per_year_by_dementia_no_dementia_plot
...
#################################By chronic respiratory failure#################################
# Use of rescue medication per year
demographics_chronic_respiratory_failure <- demographics[ , c("ENROLID", "chronic_respiratory_failure")] %>% 
  distinct(ENROLID, chronic_respiratory_failure) %>% 
  collect()

rescue_medication_use_per_year_by_chronic_respiratory_failure <- inflation_adjusted_rescue_medication_epilepsy %>% 
  left_join(demographics_chronic_respiratory_failure, by="ENROLID") %>% 
  filter(!is.na(chronic_respiratory_failure)) %>% 
  group_by(year(SVCDATE), chronic_respiratory_failure) %>% 
  mutate(total_rescue_medication_prescriptions_per_year = n()) %>% 
  ungroup() %>% 
  group_by(year(SVCDATE), chronic_respiratory_failure, rescue_medication) %>% 
  summarize(
    proportion_use_per_year = n() / total_rescue_medication_prescriptions_per_year
  ) %>% 
  distinct(`year(SVCDATE)`, chronic_respiratory_failure, rescue_medication, .keep_all=TRUE) %>% 
  ungroup() %>% 
  group_by(`year(SVCDATE)`, chronic_respiratory_failure) %>% 
  arrange(desc(proportion_use_per_year), .by_group=TRUE) %>% 
  collect()
rescue_medication_use_per_year_by_chronic_respiratory_failure




# Use of rescue medication per year figure
rescue_medication_use_per_year_by_chronic_respiratory_failure_chronic_respiratory_failure_plot <- ggplot(data=rescue_medication_use_per_year_by_chronic_respiratory_failure[rescue_medication_use_per_year_by_chronic_respiratory_failure$chronic_respiratory_failure==1, ],
                                aes(x=`year(SVCDATE)`, y=proportion_use_per_year, color=rescue_medication)) + 
  scale_color_manual(values = c("rectal diazepam" = "red",
                                "intranasal midazolam"="purple4",
                                "intranasal diazepam"="greenyellow")) +
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 1, 0.2), limits = c(0, 1))
rescue_medication_use_per_year_by_chronic_respiratory_failure_chronic_respiratory_failure_plot




rescue_medication_use_per_year_by_chronic_respiratory_failure_no_chronic_respiratory_failure_plot <- ggplot(data=rescue_medication_use_per_year_by_chronic_respiratory_failure[rescue_medication_use_per_year_by_chronic_respiratory_failure$chronic_respiratory_failure==0, ],
                                aes(x=`year(SVCDATE)`, y=proportion_use_per_year, color=rescue_medication)) + 
  scale_color_manual(values = c("rectal diazepam" = "red",
                                "intranasal midazolam"="purple4",
                                "intranasal diazepam"="greenyellow")) +
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 1, 0.2), limits = c(0, 1))
rescue_medication_use_per_year_by_chronic_respiratory_failure_no_chronic_respiratory_failure_plot
...
#################################By rural residence#################################
# Use of rescue medication per year
demographics_rural <- demographics[ , c("ENROLID", "rural")] %>% 
  distinct(ENROLID, rural) %>% 
  collect()

rescue_medication_use_per_year_by_rural <- inflation_adjusted_rescue_medication_epilepsy %>% 
  left_join(demographics_rural, by="ENROLID") %>% 
  filter(!is.na(rural)) %>% 
  group_by(year(SVCDATE), rural) %>% 
  mutate(total_rescue_medication_prescriptions_per_year = n()) %>% 
  ungroup() %>% 
  group_by(year(SVCDATE), rural, rescue_medication) %>% 
  summarize(
    proportion_use_per_year = n() / total_rescue_medication_prescriptions_per_year
  ) %>% 
  distinct(`year(SVCDATE)`, rural, rescue_medication, .keep_all=TRUE) %>% 
  ungroup() %>% 
  group_by(`year(SVCDATE)`, rural) %>% 
  arrange(desc(proportion_use_per_year), .by_group=TRUE) %>% 
  collect()
rescue_medication_use_per_year_by_rural




# Use of rescue medication per year figure
rescue_medication_use_per_year_by_rural_rural_plot <- ggplot(data=rescue_medication_use_per_year_by_rural[rescue_medication_use_per_year_by_rural$rural=="yes", ],
                                aes(x=`year(SVCDATE)`, y=proportion_use_per_year, color=rescue_medication)) + 
  scale_color_manual(values = c("rectal diazepam" = "red",
                                "intranasal midazolam"="purple4",
                                "intranasal diazepam"="greenyellow")) +
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 1, 0.2), limits = c(0, 1))
rescue_medication_use_per_year_by_rural_rural_plot




rescue_medication_use_per_year_by_rural_urban_plot <- ggplot(data=rescue_medication_use_per_year_by_rural[rescue_medication_use_per_year_by_rural$rural=="no", ],
                                aes(x=`year(SVCDATE)`, y=proportion_use_per_year, color=rescue_medication)) + 
  scale_color_manual(values = c("rectal diazepam" = "red",
                                "intranasal midazolam"="purple4",
                                "intranasal diazepam"="greenyellow")) +
  ...
  scale_x_continuous(name="Year", breaks=2006:2022) +
  scale_y_continuous(name="Proportion", breaks=seq(0, 1, 0.2), limits = c(0, 1))
rescue_medication_use_per_year_by_rural_urban_plot
```
...
rescue_medication_cost_per_year_by_generic <- rescue_medication_cost_per_year_by_generic[!(rescue_medication_cost_per_year_by_generic$`year(SVCDATE)`==2006 & rescue_medication_cost_per_year_by_generic$generic_binary=="generic"), ]
...
```{r}
# Unadjusted p-values
unadjusted_p_values <- c(jonckheere_proportion_with_rescue_medication_per_year_p_value,
jonckheere_proportion_with_rescue_medication_per_year_p_value_2018_2022,
jonckheere_proportion_with_rescue_medication_per_year_by_age_groups_0_5_y_p_value,
jonckheere_proportion_with_rescue_medication_per_year_by_age_groups_0_5_y_p_value_2018_2022,
jonckheere_proportion_with_rescue_medication_per_year_by_age_groups_6_12_y_p_value,
...
jonckheere_proportion_with_rescue_medication_per_year_by_rural_urban_p_value,
jonckheere_proportion_with_rescue_medication_per_year_by_rural_urban_p_value_2018_2022,
rescue_medication_logistic_regression_age_more_than_60_y_p_value,
rescue_medication_logistic_regression_age_0_5_y_p_value,
rescue_medication_logistic_regression_age_22_35_y_p_value,
rescue_medication_logistic_regression_age_36_50_y_p_value,
rescue_medication_logistic_regression_age_51_60_y_p_value,
rescue_medication_logistic_regression_age_6_12_y_p_value,
rescue_medication_logistic_regression_male_p_value,
rescue_medication_logistic_regression_refractory_p_value,
rescue_medication_logistic_regression_ED_IP_1_3_p_value,
rescue_medication_logistic_regression_ED_IP_more_than_3_p_value,
rescue_medication_logistic_regression_north_east_p_value,
rescue_medication_logistic_regression_north_central_p_value,
rescue_medication_logistic_regression_south_p_value,
rescue_medication_logistic_regression_other_region_p_value,
rescue_medication_logistic_regression_full_time_p_value,
rescue_medication_logistic_regression_dementia_p_value,
rescue_medication_logistic_regression_chronic_respiratory_failure_p_value,
rescue_medication_logistic_regression_rural_p_value,
jonckheere_rescue_medication_cost_AWP_per_year_p_value,
jonckheere_rescue_medication_cost_AWP_per_year_p_value_2018_2022,
jonckheere_rescue_medication_cost_patient_cost_per_year_p_value,
jonckheere_rescue_medication_cost_patient_cost_per_year_p_value_2018_2022,
