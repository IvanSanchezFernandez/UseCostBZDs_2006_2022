...
# Sensitivity analysis sensitive epilepsy definition in: Evolution in the prescription and cost of non-intravenous rescue benzodiazepines for the treatment of seizure emergencies
...
Identify patients with epilepsy or other seizures
```{r}
...
epilepsy_2006_i <- ms_i_2006 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9,
  ...
  filter(
                                        ...
                                        DX1 %in% codes_seizure_ICD9 | 
                                        DX2 %in% codes_seizure_ICD9 |
                                        DX3 %in% codes_seizure_ICD9 |  
                                        DX4 %in% codes_seizure_ICD9 |
                                        DX5 %in% codes_seizure_ICD9 |
                                        DX6 %in% codes_seizure_ICD9 |
                                        DX7 %in% codes_seizure_ICD9 |
                                        DX8 %in% codes_seizure_ICD9 |
                                        DX9 %in% codes_seizure_ICD9 |
                                        DX10 %in% codes_seizure_ICD9 |
                                        DX11 %in% codes_seizure_ICD9 |
                                        DX12 %in% codes_seizure_ICD9 |
                                        DX13 %in% codes_seizure_ICD9 |
                                        DX14 %in% codes_seizure_ICD9 |
                                        DX15 %in% codes_seizure_ICD9
...
epilepsy_2015_i <- ms_i_2015 %>% select(ENROLID, AGE, SEX, DX1, DX2, DX3, DX4, DX5, DX6, DX7, DX8, DX9,
  ...
  filter(
                                        ...
                                        DX1 %in% codes_seizure_ICD10 | 
                                        DX2 %in% codes_seizure_ICD10 |
                                        DX3 %in% codes_seizure_ICD10 |  
                                        DX4 %in% codes_seizure_ICD10 |
                                        DX5 %in% codes_seizure_ICD10 |
                                        DX6 %in% codes_seizure_ICD10 |
                                        DX7 %in% codes_seizure_ICD10 |
                                        DX8 %in% codes_seizure_ICD10 |
                                        DX9 %in% codes_seizure_ICD10 |
                                        DX10 %in% codes_seizure_ICD10 |
                                        DX11 %in% codes_seizure_ICD10 |
                                        DX12 %in% codes_seizure_ICD10 |
                                        DX13 %in% codes_seizure_ICD10 |
                                        DX14 %in% codes_seizure_ICD10 |
                                        DX15 %in% codes_seizure_ICD10
                                      ) %>% mutate(across(c(ENROLID, AGE), as.numeric)) %>% 
                                      filter(ENROLID>0) %>%    
                                      mutate(SVCDATE=ADMDATE) %>%
                                      distinct(ENROLID, SVCDATE) %>% 
...
# Patients with epilepsy (at least 2 different physician claims or inpatient or emergency department codes for epilepsy --over 2 years lower in the code)
...
# Refractory epilepsy (at least a code for refractory epilepsy --or at least 3 antiseiuzre medications lower in the code)
...
# Refractory epilepsy because at least 3 antiseizure medication prescriptions
refractory_epilepsy_because_3_ASM <- patients_with_epilepsy_and_ASM %>% 
  group_by(ENROLID) %>% 
  mutate(number_ASM = length(unique(ASM))) %>% 
  ungroup() %>% 
  filter(number_ASM > 2) %>% 
  distinct(ENROLID, .keep_all=TRUE) %>% 
  collect()
...
demographics <- demographics %>% 
  mutate(refractory_epilepsy_case = case_when(
    (ENROLID %in% !!refractory_epilepsy$ENROLID) | (ENROLID %in% !!refractory_epilepsy_because_3_ASM$ENROLID) ~ "refractory",
    TRUE ~ "non-refractory"
  )) %>% 
  collect()
...
proportion_with_rescue_medication_per_year_plot <- ggplot(data=proportion_with_rescue_medication_per_year[proportion_with_rescue_medication_per_year$year %in% 2006:2022, ],
...
proportion_with_rescue_medication_per_year_plot_detail <- ggplot(data=proportion_with_rescue_medication_per_year[proportion_with_rescue_medication_per_year$year %in% 2006:2022, ],
                                aes(x=year, y=proportion_patients_with_rescue_medication_per_year)) + 
  geom_line(lwd=1.5, color="darkgreen") + 
  theme(legend.position="none", panel.background=element_blank(), panel.grid.major=element_blank(), panel.grid.minor=element_blank(), panel.border=element_blank(), axis.ticks=element_blank(),
        axis.text=element_text(size=14, face="bold"), axis.text.x=element_text(angle=45, hjust=1),
...
proportion_with_rescue_medication_per_year_by_age_groups_plot <- ggplot(data=proportion_with_rescue_medication_per_year_by_age_groups[proportion_with_rescue_medication_per_year_by_age_groups$year %in% 2006:2022, ],
...
proportion_with_rescue_medication_per_year_by_age_groups_plot_detail <- ggplot(data=proportion_with_rescue_medication_per_year_by_age_groups[proportion_with_rescue_medication_per_year_by_age_groups$year %in% 2006:2022, ],
                                aes(x=year, y=proportion_patients_with_rescue_medication_per_year, color=age_groups)) + 
  scale_color_manual(values = c("0-5 years" = "aquamarine4",
                                "6-12 years"="deeppink",
                                "13-21 years"="navyblue",
...
proportion_with_rescue_medication_per_year_by_refractory_epilepsy_plot <- ggplot(data=proportion_with_rescue_medication_per_year_by_refractory_epilepsy[proportion_with_rescue_medication_per_year_by_refractory_epilepsy$year %in% 2006:2022, ],
...
proportion_with_rescue_medication_per_year_by_refractory_epilepsy_plot_detail <- ggplot(data=proportion_with_rescue_medication_per_year_by_refractory_epilepsy[proportion_with_rescue_medication_per_year_by_refractory_epilepsy$year %in% 2006:2022, ],
                                aes(x=year, y=proportion_patients_with_rescue_medication_per_year, color=refractory_epilepsy_case)) + 
  scale_color_manual(values = c("refractory" = "dodgerblue",
                                "non-refractory"="salmon4")) +
  geom_line(lwd=1.5) + 
...
proportion_with_rescue_medication_per_year_by_IP_ED_epilepsy_visits_plot <- ggplot(data=proportion_with_rescue_medication_per_year_by_IP_ED_epilepsy_visits[proportion_with_rescue_medication_per_year_by_IP_ED_epilepsy_visits$year %in% 2006:2022, ],
...
proportion_with_rescue_medication_per_year_by_IP_ED_epilepsy_visits_plot_detail <- ggplot(data=proportion_with_rescue_medication_per_year_by_IP_ED_epilepsy_visits[proportion_with_rescue_medication_per_year_by_IP_ED_epilepsy_visits$year %in% 2006:2022, ],
                                aes(x=year, y=proportion_patients_with_rescue_medication_per_year, color=total_epilepsy_encounters_categorical)) + 
  scale_color_manual(values = c("0" = "cyan2",
                                "1-3"="yellow1",
                                ">3"="brown2")) +
...
proportion_with_rescue_medication_per_year_by_dementia_plot <- ggplot(data=proportion_with_rescue_medication_per_year_by_dementia[proportion_with_rescue_medication_per_year_by_dementia$year %in% 2006:2022, ],
...
proportion_with_rescue_medication_per_year_by_dementia_plot_detail <- ggplot(data=proportion_with_rescue_medication_per_year_by_dementia[proportion_with_rescue_medication_per_year_by_dementia$year %in% 2006:2022, ],
                                aes(x=year, y=proportion_patients_with_rescue_medication_per_year, color=factor(dementia))) + 
  scale_color_manual(values = c("0" = "aquamarine4", 
                                "1" = "gray57")) +
  geom_line(lwd=1.5) + 
...
proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_plot <- ggplot(data=proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure[proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure$year %in% 2006:2022, ],
...
proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure_plot_detail <- ggplot(data=proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure[proportion_with_rescue_medication_per_year_by_chronic_respiratory_failure$year %in% 2006:2022, ],
                                aes(x=year, y=proportion_patients_with_rescue_medication_per_year, color=factor(chronic_respiratory_failure))) + 
  scale_color_manual(values = c("0" = "orchid4", 
                                "1" = "khaki4")) +
  geom_line(lwd=1.5) + 
...
proportion_with_rescue_medication_per_year_by_rural_plot <- ggplot(data=proportion_with_rescue_medication_per_year_by_rural[proportion_with_rescue_medication_per_year_by_rural$year %in% 2006:2022, ],
...
proportion_with_rescue_medication_per_year_by_rural_plot_detail <- ggplot(data=proportion_with_rescue_medication_per_year_by_rural[proportion_with_rescue_medication_per_year_by_rural$year %in% 2006:2022, ],
                                aes(x=year, y=proportion_patients_with_rescue_medication_per_year, color=rural)) + 
  scale_color_manual(values = c("no" = "hotpink4", 
                                "yes" = "azure4")) +
  geom_line(lwd=1.5) + 
...
# Figure rescue medication cost per year
rescue_medication_AWP_cost_per_year_by_generic_plot <- ggplot(data=rescue_medication_cost_per_year_by_generic[!((rescue_medication_cost_per_year_by_generic$generic_binary=="generic") & (rescue_medication_cost_per_year_by_generic$`year(SVCDATE)`==2006)), ]) + 
...
rescue_medication_patient_cost_per_year_by_generic_plot <- ggplot(data=rescue_medication_cost_per_year_by_generic[!((rescue_medication_cost_per_year_by_generic$generic_binary=="generic") & (rescue_medication_cost_per_year_by_generic$`year(SVCDATE)`==2006)), ]) + 
