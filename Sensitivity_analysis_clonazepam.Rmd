...
# Sensitivity analysis clonazepam as rescue medication in: Evolution in the prescription and cost of non-intravenous rescue benzodiazepines for the treatment of seizure emergencies
...
codes_NDCNUM_oral_CNZ_2006 <- redbook_2006_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )
    ) %>% 
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2006 <- as.numeric(codes_NDCNUM_oral_CNZ_2006)


codes_NDCNUM_oral_CNZ_2007 <- redbook_2007_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2007 <- as.numeric(codes_NDCNUM_oral_CNZ_2007)


codes_NDCNUM_oral_CNZ_2008 <- redbook_2008_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2008 <- as.numeric(codes_NDCNUM_oral_CNZ_2008)


codes_NDCNUM_oral_CNZ_2009 <- redbook_2009_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2009 <- as.numeric(codes_NDCNUM_oral_CNZ_2009)


codes_NDCNUM_oral_CNZ_2010 <- redbook_2010_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2010 <- as.numeric(codes_NDCNUM_oral_CNZ_2010)


codes_NDCNUM_oral_CNZ_2011 <- redbook_2011_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2011 <- as.numeric(codes_NDCNUM_oral_CNZ_2011)


codes_NDCNUM_oral_CNZ_2012 <- redbook_2012_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2012 <- as.numeric(codes_NDCNUM_oral_CNZ_2012)


codes_NDCNUM_oral_CNZ_2013 <- redbook_2013_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2013 <- as.numeric(codes_NDCNUM_oral_CNZ_2013)


codes_NDCNUM_oral_CNZ_2014 <- redbook_2014_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2014 <- as.numeric(codes_NDCNUM_oral_CNZ_2014)


codes_NDCNUM_oral_CNZ_2015 <- redbook_2015_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )    
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2015 <- as.numeric(codes_NDCNUM_oral_CNZ_2015)


codes_NDCNUM_oral_CNZ_2016 <- redbook_2016_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )    
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2016 <- as.numeric(codes_NDCNUM_oral_CNZ_2016)


codes_NDCNUM_oral_CNZ_2017 <- redbook_2017_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )    
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2017 <- as.numeric(codes_NDCNUM_oral_CNZ_2017)


codes_NDCNUM_oral_CNZ_2018 <- redbook_2018_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )    
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2018 <- as.numeric(codes_NDCNUM_oral_CNZ_2018)


codes_NDCNUM_oral_CNZ_2019 <- redbook_2019_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )    
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2019 <- as.numeric(codes_NDCNUM_oral_CNZ_2019)


codes_NDCNUM_oral_CNZ_2020 <- redbook_2020_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )    
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2020 <- as.numeric(codes_NDCNUM_oral_CNZ_2020)


codes_NDCNUM_oral_CNZ_2021 <- redbook_2021_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )    
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2021 <- as.numeric(codes_NDCNUM_oral_CNZ_2021)


codes_NDCNUM_oral_CNZ_2022 <- redbook_2022_data %>% 
  filter(
      ( grepl("klonopin", PRODNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE) ) |
      ( grepl("clonazepam", GENNME, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  ) |
      ( grepl("clonazepam", THRDTDS, ignore.case=TRUE) & grepl("ODT", MASTFRM, ignore.case=TRUE)  )    
  ...
  pull(NDCNUM)
codes_NDCNUM_oral_CNZ_2022 <- as.numeric(codes_NDCNUM_oral_CNZ_2022)
```
...
rescue_medication_epilepsy_2006 <- ms_d_2006 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2006) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2006) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2006) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2006))  %>%
  ...
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2006 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2007 <- ms_d_2007 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2007) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2007) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2007) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2007))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2007 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2008 <- ms_d_2008 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2008) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2008) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2008) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2008))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2008 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2009 <- ms_d_2009 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2009) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2009) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2009) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2009))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2009 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2010 <- ms_d_2010 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2010) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2010) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2010) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2010))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2010 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2011 <- ms_d_2011 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2011) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2011) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2011) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2011))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2011 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2012 <- ms_d_2012 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2012) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2012) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2012) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2012))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2012 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2013 <- ms_d_2013 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2013) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2013) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2013) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2013))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2013 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2014 <- ms_d_2014 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2014) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2014) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2014) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2014))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2014 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2015 <- ms_d_2015 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2015) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2015) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2015) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2015))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2015 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2016 <- ms_d_2016 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2016) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2016) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2016) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2016))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2016 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2017 <- ms_d_2017 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2017) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2017) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2017) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2017))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2017 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2018 <- ms_d_2018 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2018) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2018) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2018) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2018))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2018 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2019 <- ms_d_2019 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2019) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2019) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2019) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2019))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2019 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2020 <- ms_d_2020 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2020) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2020) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2020) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2020))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2020 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2021 <- ms_d_2021 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2021) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2021) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2021) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2021))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2021 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy_2022 <- ms_d_2022 %>% 
  filter(ENROLID %in% !!patients_with_epilepsy_and_ASM_no_gaps$ENROLID) %>% 
  filter( (NDCNUM %in% codes_NDCNUM_rectal_DZP_2022) | (NDCNUM %in% codes_NDCNUM_intranasal_MDZ_2022) | (NDCNUM %in% codes_NDCNUM_intranasal_DZP_2022) | (NDCNUM %in% codes_NDCNUM_oral_CNZ_2022))  %>%
  select(ENROLID, SVCDATE, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY) %>% 
  mutate(across(c(ENROLID, AWP, COB, COINS, COPAY, DEDUCT, DISPFEE, GENERID, INGCOST, NETPAY, PAY, SALETAX, GENIND, DAYSUPP, RXMR, NDCNUM, METQTY), as.numeric)) %>%
  collect() %>% 
  mutate(across(SVCDATE, mdy)) %>% 
  mutate(rescue_medication = case_when(
    ...
    NDCNUM %in% codes_NDCNUM_oral_CNZ_2022 ~ "oral clonazepam"
  ))
...
rescue_medication_epilepsy <- bind_rows(rescue_medication_epilepsy_2006, rescue_medication_epilepsy_2007, rescue_medication_epilepsy_2008, rescue_medication_epilepsy_2009, rescue_medication_epilepsy_2010, rescue_medication_epilepsy_2011, rescue_medication_epilepsy_2012, rescue_medication_epilepsy_2013, rescue_medication_epilepsy_2014, rescue_medication_epilepsy_2015, rescue_medication_epilepsy_2016, rescue_medication_epilepsy_2017, rescue_medication_epilepsy_2018, rescue_medication_epilepsy_2019, rescue_medication_epilepsy_2020, rescue_medication_epilepsy_2021, rescue_medication_epilepsy_2022) %>% 
  filter(((rescue_medication=="rectal diazepam") | (rescue_medication=="intranasal midazolam") | (rescue_medication=="intranasal diazepam") | ((rescue_medication=="oral clonazepam") & (DAYSUPP<15)))) %>% 
...
rescue_medication_cost_per_year <- inflation_adjusted_rescue_medication_epilepsy %>% 
  ...
  mutate(
    AWP_per_unit = case_when(
      ...
      rescue_medication=="oral clonazepam" ~ AWP / METQTY
    ),
    patient_cost_per_unit = case_when(
      ...
      rescue_medication=="oral clonazepam" ~ sum(COINS, COPAY, DEDUCT, DISPFEE) / METQTY
    )
  ) %>% 
  ungroup() %>% 
  group_by(year(SVCDATE)) %>% 
