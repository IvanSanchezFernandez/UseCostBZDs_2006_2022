...
logistic_regression_database <- demographics %>% 
  ...
  select(ENROLID, age_0_5_y, age_6_12_y, age_13_21_y, age_22_35_y, age_36_50_y, male, refractory, ED_IP_1_3, ED_IP_more_than_3, north_east, north_central, south, other_region, full_time) %>% 
  mutate(rescue = case_when(
    ENROLID %in% !!inflation_adjusted_rescue_medication_epilepsy$ENROLID ~ 1,
    TRUE ~ 0)
    ) %>% 
  select(ENROLID, rescue, age_0_5_y, age_6_12_y, age_13_21_y, age_22_35_y, age_36_50_y, male, refractory, ED_IP_1_3, ED_IP_more_than_3, north_east, north_central, south, other_region, full_time) %>% 
  collect()
...
# Logistic regression
rescue_medication_logistic_regression <- glm(rescue ~ age_0_5_y + age_6_12_y + age_13_21_y + age_22_35_y + age_36_50_y + male + refractory + ED_IP_1_3 + ED_IP_more_than_3 + north_east + north_central + south + other_region + full_time, data=logistic_regression_database, family="binomial")
